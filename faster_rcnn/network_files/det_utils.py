...
class BoxCoder(object):
    ...
    def encode(self, reference_boxes, proposals):
        ...
        Args:
            reference_boxes: List[Tensor]  proposal/anchor gt_boxes
    ...
    def decode_single(self, rel_codes, boxes):
        ...
        # xmin, ymin, xmax, ymax
        widths = boxes[:, 2] - boxes[:, 0]   # anchor/proposal 
        heights = boxes[:, 3] - boxes[:, 1]  # anchor/proposal 
        ...
        dx = rel_codes[:, 0::4] / wx   #  anchors/proposals x 
        dy = rel_codes[:, 1::4] / wy   #  anchors/proposals y 
        dw = rel_codes[:, 2::4] / ww   #  anchors/proposals 
        dh = rel_codes[:, 3::4] / wh   #  anchors/proposals 
...
class Matcher(object):
    ...
    def __call__(self, match_quality_matrix):
        ...
        # M x N  anchors gt iou 
        # matched_vals ， anchors gt iou 
        # matches 
        ...
        #  iou low_threshold high_threshold 
        between_thresholds = (matched_vals >= self.low_threshold) & (
            matched_vals < self.high_threshold
        )
        # iou low_threshold matches -1
        matches[below_low_threshold] = self.BELOW_LOW_THRESHOLD  # -1

        # iou [low_threshold, high_threshold] matches -2
    ...
    def set_low_quality_matches_(self, matches, all_matches, match_quality_matrix):
        ...
        # gt_pred_pairs_of_highest_quality[:, 0] gt index( )
