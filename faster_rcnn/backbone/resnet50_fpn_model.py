...
def resnet50_fpn_backbone(pretrain_path="",
                          norm_layer=FrozenBatchNorm2d,  # FrozenBatchNorm2d  BatchNorm2d  ，  
                          trainable_layers=3,
    ...
    Args:
        pretrain_path: resnet50  ，  
        norm_layer:   FrozenBatchNorm2d，  bn  (  batch_size  ，  bn  )
                      GPU  batch_size，  BatchNorm2d  
